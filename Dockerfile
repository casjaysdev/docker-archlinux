...
ARG BUILD_DATE="Fri Sep  1 09:19:44 AM EDT 2023"
...
ARG PACK_LIST="bash bash bash-completion git curl wget sudo unzip base-devel mailx postfix python python-pip"
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdev/docker-archlinux" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdev/docker-archlinux" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdev/docker-archlinux" \
  org.opencontainers.image.documentation="https://github.com/casjaysdev/docker-archlinux" \
