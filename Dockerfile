...
ARG PACK_LIST="bash-completion git curl wget sudo unzip base-devel mailx postfix python python-pip \
  "
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/archlinux" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/archlinux" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/archlinux" \
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/archlinux" \
